...
```{r total_per_day_mean_median, results='hide'}
# calculate mean
...
Calculated mean is **`r total_steps_per_day_mean`** and median is **`r total_steps_per_day_median`**.
...
Interval id with maximum value is **`r interval_max`**.
